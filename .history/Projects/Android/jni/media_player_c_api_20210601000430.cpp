...
// {
//   auto _media_player_source = reinterpret_cast<AgoraMediaPlayerSource
//   *>(observer); auto _media_player = reinterpret_cast<IMediaPlayer
//   *>(mediaPlayer);
