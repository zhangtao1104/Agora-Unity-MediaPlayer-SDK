...
#define PRINTF(...)                                                            \
  __android_log_print(ANDROID_LOG_INFO, "CWrapper", __VA_ARGS__)
#define AGORA_STD_CALL
...
typedef void(AGORA_STD_CALL *FUNC_OnPlayerSourceStateChanged)(int state,
                                                              int ec);
typedef void(AGORA_STD_CALL *FUNC_OnPositionChanged)(int64_t position);
typedef void(AGORA_STD_CALL *FUNC_OnPlayerEvent)(int event,
                                                 int64_t elapsedTimem,
                                                 const char *message);
typedef void(AGORA_STD_CALL *FUNC_OnMetaData)(const void *data, int length);
typedef void(AGORA_STD_CALL *FUNC_OnPlayBufferUpdated)(
...
typedef void(AGORA_STD_CALL *FUNC_OnFrame)(VideoFrame *videoFrame);

typedef struct EventListener {
  FUNC_OnFrame _onFrame;
