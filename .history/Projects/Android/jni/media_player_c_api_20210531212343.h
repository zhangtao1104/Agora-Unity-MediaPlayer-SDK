...
AGORA_API int registerPlayerSourceObserver(IMediaPlayerSourceObserver* observer);
AGORA_API int unregisterPlayerSourceObserver(IMediaPlayerSourceObserver* observer);
