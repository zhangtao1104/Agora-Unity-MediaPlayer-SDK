...
void *media_player_registerPlayerSourceObserver(void *mediaPlayer,
  ...
  auto _media_player_source = new AgoraMediaPlayerSource(listener);
...
int media_player_registerVideoFrameObserver(void *mediaPlayer, void *_media_player_source) { 
  auto _media_player_event = reinterpret_cast<AgoraMediaPlayerSource *>(_media_player_source);
  auto _media_player = reinterpret_cast<IMediaPlayer *>(mediaPlayer);
  auto ret = _media_player->registerVideoFrameObserver(_media_player_event);
  return ret; 
}

int media_player_unregisterVideoFrameObserver(void *mediaPlayer, void *_media_player_source) { 
  auto _media_player_event = reinterpret_cast<AgoraMediaPlayerSource *>(_media_player_source);
  auto _media_player = reinterpret_cast<IMediaPlayer *>(mediaPlayer);
