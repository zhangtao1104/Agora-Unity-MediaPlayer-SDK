...
AGORA_API int media_player_open(void *mediaPlayer, const char* url, int64_t startPos);
...
AGORA_API int media_player_takeScreenshot(void *mediaPlayer, const char* filename);
...
AGORA_API void* media_player_registerPlayerSourceObserver(void* mediaPlayer, void* observer);
AGORA_API int media_player_unregisterPlayerSourceObserver(void* mediaPlayer, void* observer);
