...
public:
  virtual int initialize(base::IAgoraService* agora_service) = 0;
	 ...
	 * - < 0: Failure.
	 */
	virtual int openWithAgoraCDN(const char* src, int64_t startPos) = 0;
	 ...
	 * - <= 0: Failure.
	 */
	virtual int getAgoraCDNCount() = 0;
	 ...
	 * - < 0: Failure.
	 */
	virtual int switchAgoraCDN(int index) = 0;
	 ...
	 * - < 0: Failure.
	 */
	virtual int getAgoraCDNIndex() = 0;
