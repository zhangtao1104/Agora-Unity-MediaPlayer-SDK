        ...
        _source_event_native = new EventListener {
            _OnPlayerSourceStateChanged =
                Marshal.GetFunctionPointerForDelegate(new FUNC_onPlayerSourceStateChanged(OnPlayerSourceStateChanged))
                    ...
                    _OnPositionChanged =
                    Marshal.GetFunctionPointerForDelegate(new FUNC_onPositionChanged(OnPositionChanged)),
            ...
            _OnPlayBufferUpdated =
                Marshal.GetFunctionPointerForDelegate(new FUNC_onPlayerBufferUpdated(OnPlayerBufferUpdated)),
