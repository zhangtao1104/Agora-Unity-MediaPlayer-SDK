...
class MediaPlayerImp : IMediaPlayer
{
    ...
    private MediaPlayerImp(string appId, MediaPlayerSourceEvent sourceEvent)
    {
        ...
        _media_player = IMediaPlayerNative.createMediaPlayer(_engine_ptr);
        _player_source_observer_ptr = IMediaPlayerNative.media_player_registerPlayerSourceObserver(_media_player, ref _source_event_native);
    }
    ...
    {
        if (_engine_ptr == IntPtr.Zero || _media_player == IntPtr.Zero)
    ...
    public override int RegisterVideoFrameObserver()
    {
        ...
        return IMediaPlayerNative.media_player_registerVideoFrameObserver(_media_player, _player_source_observer_ptr);
    }
    public override int UnregisterVideoFrameObserver()
    {
        ...
        return IMediaPlayerNative.media_player_unregisterVideoFrameObserver(_media_player, _player_source_observer_ptr);
    }
    ...
    public override void Release(bool sync)
    {
        ...
        IMediaPlayerNative.media_player_unregisterPlayerSourceObserver(_media_player, _player_source_observer_ptr);
        IMediaPlayerNative.media_player_release(_engine_ptr, _media_player, sync);
