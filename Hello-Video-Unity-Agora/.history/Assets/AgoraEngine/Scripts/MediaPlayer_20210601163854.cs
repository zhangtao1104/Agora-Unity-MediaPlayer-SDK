...
class MediaPlayerImp : IMediaPlayer
{
    ...
    public void OnPlayerSourceStateChanged(MEDIA_PLAYER_STATE state, MEDIA_PLAYER_ERROR ec)
    {
        ...
        Debug.Log("CWrapper: _OnPlayerSourceStateChanged 222state " + (int)state + " ec " + (int)ec);
    }
