...
class MediaPlayerImp : IMediaPlayer
{
    ...
    private MediaPlayerImp(string appId, MediaPlayerSourceEvent sourceEvent)
    {
        ...
        _player_source_handler = IMediaPlayerNative.media_player_registerPlayerSourceObserver(_media_player, ref _source_event_native);
    }
    ...
    public override int RegisterVideoFrameObserver()
    {
        ...
        return IMediaPlayerNative.media_player_registerVideoFrameObserver(_media_player, _player_source_handler);
    }
    public override int UnregisterVideoFrameObserver()
    {
        ...
        return IMediaPlayerNative.media_player_unregisterVideoFrameObserver(_media_player, _player_source_handler);
    }
