...
{
    public Action<MEDIA_PLAYER_STATE, MEDIA_PLAYER_ERROR> OnPlayerSourceStateChanged = default;
    public Action<long> OnPositionChanged;
    public Action<MEDIA_PLAYER_EVENT, long, string> OnPlayerEvent;
    public Action<IntPtr, int> OnMetaData;
    public Action<long> OnPlayerBufferUpdated;
    public Action<string, PLAYER_PRELOAD_EVENT> OnPreloadevent;
