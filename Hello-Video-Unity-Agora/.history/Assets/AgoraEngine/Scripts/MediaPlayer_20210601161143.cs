...
class MediaPlayerImp : IMediaPlayer
{
    ...
    private EventListener InitHandler()
    {
        _source_event_native = new EventListener { 
            test = 10,
            _OnPlayerSourceStateChanged = OnPlayerSourceStateChanged

            Marshal.GetFunctionPointerForDelegate(OnPlayerSourceStateChanged)
    ...
    public static void OnPlayerSourceStateChanged(int state, int ec)
    {
