...
class EventHandler : MediaPlayerSourceEvent {
    ...
    {
        Debug.Log("CWrapper :  OnPlayerEvent events = " + (int)events);
    }
    ...
    {
        Debug.Log("CWrapper :  OnPlayBufferUpdated playCachedBuffer = " + playCachedBuffer);
    }
    ...
    {
        Debug.Log("CWrapper :  OnCompleted");
    }
